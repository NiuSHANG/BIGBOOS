{
     ...
     * @return {string}
     */
    let getStyleValue = function(element, style) {
     ...
     * @return {number}
     */
    let getLineHeight = function (element) {
     ...
     */
    let setupLineHeight = function(element, lineHeight) {
     ...
     * @param {HTMLElement} element
     */
    let removeLineHeight = function(element) {
        for (var index = 0; index < element.childNodes.length; index++) {
            var childNode = element.childNodes[index];
     ...
     * @return {boolean}
     */
    let truncateTextNode = function(textNode, rootElement, maxHeight) {
     ...
     * @return {boolean}
     */
    let truncateElementNode = function(element, rootElement, maxHeight, lineHeight) {
     ...
     */
    let truncate = function(rootElement, lineCount) {
     ...
     * @param {number} lineCount
     */
    let native = function(rootElement, lineCount) {
